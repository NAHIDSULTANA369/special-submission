...
namespace Contact_App
{
    ...
    {
        SqlConnection sqlCon = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=E:\Youtube Channel\Dotnet Mob\Windows Application\Save Update Delete View\DB\ContactDB.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True");
        int ContactId = 0;
        public Form1()
        {
            InitializeComponent();
